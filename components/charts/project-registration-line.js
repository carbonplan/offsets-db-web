import { Chart, Grid, Plot, Ticks, TickLabels, Line } from '@carbonplan/charts'
      ...
      <Box sx={{ height: '200px', mt: 3 }}>
        <Chart x={[2000, 2023]} y={range} padding={{ left: 0 }}>
          ...
          <Plot>
            ...
            <Line data={lines} color='secondary' />
            <Line data={filteredLines} />
          </Plot>
        </Chart>
      </Box>
    </>
...
export default ProjectRegistrationLine
